  ...
  return (
    <div className="flex flex-col min-h-screen py-24 mx-8">
      ...
      <div className="flex gap-8">
        <div className="flex flex-col w-1/4 p-4 border rounded-lg shadow-lg">
      ...
      <div className="overflow-x-hidden">
        <div className="py-12 animate-marquee-infinite whitespace-nowrap flex">
          <div className="relative h-[150px] w-[250px] mx-16 aspect-video">
          ...
          <div className="relative h-[150px] w-[250px] mx-16 aspect-square">
