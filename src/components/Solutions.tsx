...
const Solutions = () => {
  return (
    <div className="flex flex-col min-h-screen py-24 mx-8">
      ...
      <div className="flex">
        <div className="w-1/2 bg-orange-300 flex flex-col  p-4 h-[332px]">
        ...
        <div className="w-1/2 my-4 h-[300px] relative">
      ...
      <div className="flex">
        ...
        <div className="w-1/2 bg-yellow-300 flex flex-col p-4 h-[332px]">
      ...
      <div className="flex">
        <div className="w-1/2 h-[300px] relative my-4">
