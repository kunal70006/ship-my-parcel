...
const Solutions = () => {
  return (
    <div className="flex flex-col min-h-screen py-24 sm:mx-8 text-white">
      <h1 className="text-4xl mb-8 font-semibold text-center text-black">
        Solutions
      </h1>
      <div className="flex sm:flex-row flex-col-reverse">
        <div className="sm:w-1/2 w-full bg-amber-500 flex flex-col p-4 sm:h-[332px] px-8 sm:px-0">
        ...
        <div className="sm:w-1/2 w-full sm:my-4 my-0 sm:h-[300px] h-[200px] sm:bg-white bg-amber-500 relative">
          <Image src="/ecomm.svg" fill alt="ecommerce" />
        </div>
      </div>
      <div className="flex sm:flex-row flex-col">
        <div className="sm:w-1/2 w-full sm:my-4 my-0 sm:h-[300px] h-[200px] sm:bg-white bg-blue-700 relative">
          <Image src="/globe.svg" fill alt="globe" />
        </div>
        <div className="sm:w-1/2  bg-blue-700 flex flex-col p-4 sm:h-[332px]">
      ...
      <div className="flex sm:flex-row flex-col-reverse">
        <div className="sm:w-1/2 bg-amber-500 flex flex-col  p-4 sm:h-[332px]">
        ...
        <div className="sm:w-1/2 sm:my-4 my-0 sm:h-[300px] h-[200px] sm:bg-white bg-amber-500 relative">
          <Image src="/cross.svg" fill alt="cross" />
        </div>
      </div>
      <div className="flex flex-col sm:flex-row">
        <div className="sm:w-1/2 sm:h-[300px] h-[200px] relative sm:my-4 bg-blue-700 sm:bg-white">
